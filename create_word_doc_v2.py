            ...
            if len(table_data) > 2: # Exclude the separator
                ...
                for r in table_data[2:]:
                    ...
                    for i, cell_text in enumerate(r):
                        if i < cols:
                            # clean up some markdown bolding
...
if __name__ == '__main__':
    md_path = r'c:\projects\tcs project\curabot\docs\LLD_AI_Safety_and_Architecture_v2.md'
    docx_path = r'c:\projects\tcs project\curabot\docs\LLD_AI_Safety_and_Architecture_v2.docx'
