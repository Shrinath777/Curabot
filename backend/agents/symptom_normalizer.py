...
class SymptomNormalizerAgent:
    ...
    def _keyword_fallback(self, message: str) -> Dict[str, Any]:
        ...
        keyword_map = {
            ...
            "balance": {"name": "difficulty_walking", "system": "neurological"},
            "walking": {"name": "difficulty_walking", "system": "neurological"},
            "walk": {"name": "difficulty_walking", "system": "neurological"},
